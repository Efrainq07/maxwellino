...
float q=10000.0,pi=3.141592654,e=8.854187817,m=0.1,aux;
int run=0;
void setup(){
  background(#FFFCFC);
...
void draw(){
  ...
  for(k=1;k<=9;k++)for(j=1;j<=18;j++){
    ...
    for(i=0;i<cargas.size();i++){
       Ex+=(1.0/(4*pi*e))*cargas.get(i)[0]*(j*72-cargas.get(i)[1])/pow((cargas.get(i)[1]-j*72)*(cargas.get(i)[1]-j*72)+(cargas.get(i)[2]-k*72)*(cargas.get(i)[2]-k*72),1.5);
       Ey+=(1.0/(4*pi*e))*cargas.get(i)[0]*(k*72-cargas.get(i)[2])/pow((cargas.get(i)[1]-j*72)*(cargas.get(i)[1]-j*72)+(cargas.get(i)[2]-k*72)*(cargas.get(i)[2]-k*72),1.5);
    }
  ...
  for(i=0; i<cargas.size();i++){
    ...
    for(j=0;j<cargas.size();j++){
      if(j!=i){
       Ex+=(1.0/(4*pi*e))*cargas.get(j)[0]*(cargas.get(i)[1]-cargas.get(j)[1])/pow((cargas.get(j)[1]-cargas.get(i)[1])*(cargas.get(j)[1]-cargas.get(i)[1])+(cargas.get(j)[2]-cargas.get(i)[2])*(cargas.get(j)[2]-cargas.get(i)[2]),1.5);
       Ey+=(1.0/(4*pi*e))*cargas.get(j)[0]*(cargas.get(i)[2]-cargas.get(j)[2])/pow((cargas.get(j)[1]-cargas.get(i)[1])*(cargas.get(j)[1]-cargas.get(i)[1])+(cargas.get(j)[2]-cargas.get(i)[2])*(cargas.get(j)[2]-cargas.get(i)[2]),1.5);
      }
    }
    ...
    if(pow(pow(cargas.get(i)[3],2)+pow(cargas.get(i)[4],2),0.5)!=0)drawArrow(cargas.get(i)[1],cargas.get(i)[2],100,random(-3,3)+degrees(atan2(cargas.get(i)[4],cargas.get(i)[3])));
    noStroke();
    if(cargas.get(i)[0]==0)fill(0,0,0);
    else fill(255,255,255);
    textSize(13);
    text("v="+String.format("%.1f",pow(pow(cargas.get(i)[3],2)+pow(cargas.get(i)[4],2),0.5))+"m/s\nq="+String.format("%.1f",cargas.get(i)[0]/1000.0)+"kC\nm="+String.format("%.1f",cargas.get(i)[5]*1000)+"g",cargas.get(i)[1]-40,cargas.get(i)[2]-20,cargas.get(i)[1]+10,cargas.get(i)[2]+10);
    if(run==1){
      cargasaux.get(i)[1]+=cargas.get(i)[3]*1.0/20.0+0.5*Ex*cargas.get(i)[0]/(400.0*cargas.get(i)[5]);
      cargasaux.get(i)[2]+=cargas.get(i)[4]*1.0/20.0+0.5*Ey*cargas.get(i)[0]/(400.0*cargas.get(i)[5]);
      cargasaux.get(i)[3]+=cargas.get(i)[0]*Ex*1.0/(20.0*cargas.get(i)[5]);
      cargasaux.get(i)[4]+=cargas.get(i)[0]*Ey*1.0/(20.0*cargas.get(i)[5]);
       for(j=0;j<i;j++){
        if(pow(pow(cargas.get(i)[1]-cargas.get(j)[1],2)+pow(cargas.get(i)[2]-cargas.get(j)[2],2),0.5)<50.0){
         cargasaux.get(i)[0]=cargas.get(i)[0]+cargas.get(j)[0];
         cargas.get(i)[0]=cargas.get(i)[0]+cargas.get(j)[0];
         cargasaux.get(i)[1]=(cargas.get(i)[1]+cargas.get(j)[1])*0.5;
         cargasaux.get(i)[2]=(cargas.get(i)[2]+cargas.get(j)[2])*0.5;
